...
def bayes_update(
    ...
    """
    Perform Beta–Binomial update for each risk row.
    """
...
def apply_ccf_beta_factor(
    ...
    """
    Apply β-factor common-cause correction within each group.
    """
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Run PRAXIS-Core scenario (single-file engine).")
